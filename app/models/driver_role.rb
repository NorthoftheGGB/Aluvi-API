class DriverRole < ActiveRecord::Base
  ...
  attr_accessible :state
	...
	has_attached_file :drivers_license, :styles => { :thumb => "100x100>" }, :default_url => "/images/:style/missing.png", :storage => :s3
	has_attached_file :vehicle_registration, :styles => { :thumb => "100x100>" }, :default_url => "/images/:style/missing.png", :storage => :s3
	has_attached_file :proof_of_insurance, :styles => { :thumb => "100x100>" }, :default_url => "/images/:style/missing.png", :storage => :s3
	has_attached_file :car_photo, :styles => { :thumb => "100x100>" }, :default_url => "/images/:style/missing.png", :storage => :s3
	has_attached_file :national_database_check, :styles => { :thumb => "100x100>" }, :default_url => "/images/:style/missing.png", :storage => :s3
